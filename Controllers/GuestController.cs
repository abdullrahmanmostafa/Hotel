...
namespace hotel.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FullName,Email,Phone")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Phone")] Guest guest)
        {
            if (id != guest.Id)
            {
                return NotFound();
